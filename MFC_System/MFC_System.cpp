...
BEGIN_MESSAGE_MAP(CMFC_SystemApp, CWinApp)
...
// 僅有的一個 CMFC_SystemApp 物件

CMFC_SystemApp theApp;


// CMFC_SystemApp 初始設定

BOOL CMFC_SystemApp::InitInstance()
{
